...
class TrafficLog(models.Model):
    ...
    threat_type = models.CharField(max_length=128, null=True, blank=True)
    threat_family = models.CharField(max_length=128, null=True, blank=True)
    threat_detail = models.TextField(null=True, blank=True)
    detection_source = models.CharField(max_length=64, null=True, blank=True)
